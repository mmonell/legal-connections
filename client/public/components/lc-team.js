...
const ICONS = {
  ...
  youtube: '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M21.6 7.2s-.21-1.5-.87-2.16c-.83-.87-1.76-.87-2.19-.92C15.4 4 12 4 12 4h-.01s-3.4 0-6.54.12c-.43.05-1.36.05-2.19.92-.66.66-.87 2.16-.87 2.16S2.17 8.94 2.17 10.68v1.63c0 1.74.22 3.48.22 3.48s.21 1.5.87 2.16c.83.87 1.92.84 2.4.94 1.75.17 7.34.22 7.34.22s3.4-.01 6.55-.13c.43-.05 1.36-.05 2.19-.92.66-.66.87-2.16.87-2.16s.22-1.74.22-3.48v-1.63c0-1.74-.22-3.48-.22-3.48zM9.98 14.6V8.9l5.4 2.86-5.4 2.85z"/></svg>',
};
